...
entity pcie is
	port (
		...
		dut_hip_pipe_phystatus1       : in  std_logic                     := '0';             --               .phystatus1
		dut_hip_pipe_phystatus2       : in  std_logic                     := '0';             --               .phystatus2
		dut_hip_pipe_phystatus3       : in  std_logic                     := '0';             --               .phystatus3
		dut_hip_pipe_rxdata0          : in  std_logic_vector(7 downto 0)  := (others => '0'); --               .rxdata0
		dut_hip_pipe_rxdata1          : in  std_logic_vector(7 downto 0)  := (others => '0'); --               .rxdata1
		dut_hip_pipe_rxdata2          : in  std_logic_vector(7 downto 0)  := (others => '0'); --               .rxdata2
		dut_hip_pipe_rxdata3          : in  std_logic_vector(7 downto 0)  := (others => '0'); --               .rxdata3
		dut_hip_pipe_rxdatak0         : in  std_logic                     := '0';             --               .rxdatak0
		dut_hip_pipe_rxdatak1         : in  std_logic                     := '0';             --               .rxdatak1
		dut_hip_pipe_rxdatak2         : in  std_logic                     := '0';             --               .rxdatak2
		dut_hip_pipe_rxdatak3         : in  std_logic                     := '0';             --               .rxdatak3
		dut_hip_pipe_rxelecidle0      : in  std_logic                     := '0';             --               .rxelecidle0
		dut_hip_pipe_rxelecidle1      : in  std_logic                     := '0';             --               .rxelecidle1
		dut_hip_pipe_rxelecidle2      : in  std_logic                     := '0';             --               .rxelecidle2
		dut_hip_pipe_rxelecidle3      : in  std_logic                     := '0';             --               .rxelecidle3
		dut_hip_pipe_rxstatus0        : in  std_logic_vector(2 downto 0)  := (others => '0'); --               .rxstatus0
		dut_hip_pipe_rxstatus1        : in  std_logic_vector(2 downto 0)  := (others => '0'); --               .rxstatus1
		dut_hip_pipe_rxstatus2        : in  std_logic_vector(2 downto 0)  := (others => '0'); --               .rxstatus2
		dut_hip_pipe_rxstatus3        : in  std_logic_vector(2 downto 0)  := (others => '0'); --               .rxstatus3
		dut_hip_pipe_rxvalid0         : in  std_logic                     := '0';             --               .rxvalid0
		dut_hip_pipe_rxvalid1         : in  std_logic                     := '0';             --               .rxvalid1
		dut_hip_pipe_rxvalid2         : in  std_logic                     := '0';             --               .rxvalid2
		dut_hip_pipe_rxvalid3         : in  std_logic                     := '0';             --               .rxvalid3
		dut_hip_serial_rx_in0         : in  std_logic                     := '0';             -- dut_hip_serial.rx_in0
		dut_hip_serial_rx_in1         : in  std_logic                     := '0';             --               .rx_in1
		dut_hip_serial_rx_in2         : in  std_logic                     := '0';             --               .rx_in2
		dut_hip_serial_rx_in3         : in  std_logic                     := '0';             --               .rx_in3
